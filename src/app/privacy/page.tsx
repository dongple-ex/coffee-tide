      ...
      <article className={styles.policy}>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              음성·회의 녹음, 전사 텍스트, 회의 주제·목적, 화자·참석자 정보 및 사용자가
              선택한 참고자료: 음성 인식, 회의록·요약·결정사항·할 일 생성
            </li>
        ...
        <section>
          ...
          <ul>
            <li>
              사용자가 음성 인식이나 회의록 분석을 실행하면 녹음 구간과 전사 텍스트가 Google
              Gemini API로 전송됩니다. 최종 회의록 정리 시에는 사용자가 입력한 회의 주제·목적,
              화자·참석자 정보, 고유명사와 직접 선택한 참고자료의 필요한 구간도 함께 전송될 수
              있습니다.
            </li>
            <li>
            ...
            <li>
              회의를 녹음하거나 참석자의 발언·이름·역할을 분석하기 전에 사용자는 해당 녹음과
              분석에 필요한 권한 또는 참석자 동의를 직접 확인해야 합니다.
            </li>
            <li>
          ...
          <p>
            음성·회의록 분석은 선택 기능입니다. 분석 전에 Gemini로 전송되는 정보의 범위를
            확인하고 최종 분석 실행 여부를 선택할 수 있으며, 사용하지 않으면 녹음이나 전사
            텍스트를 Gemini에 전송하지 않습니다.
          </p>
        </section>
