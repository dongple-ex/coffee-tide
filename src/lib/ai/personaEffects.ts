...
const PERSONA_EFFECTS: Record<PersonaKind, PersonaEffect> = {
  ...
  ropan: {
    ...
    menu: ROPAN_MENU,
    brewBubbles: [
      "🛎️ 공녀, 주문하신 황실 홍차를 준비해 올리겠습니다. ☕ (아싸, 오늘 첫 주문! 실수하지 말자!)",
      "🛎️ 귀족 공녀들의 티파티에 어울리는 마카롱 프라페 대령했습니다. 🍧 (시럽 폭탄인 건 안 비밀 ㅋㅋ)",
    ...
    servedMessage: (_name, drink) => `🛎️ 공녀, 주문하신 ${drink} 대령했습니다. (맛있게 먹어라 얍!)`,
    cutin: {
      badge: "✨ ROMANCE FANTASY",
      title: "공녀를 위한 완벽한 한 잔",
