...
> ⚠️ **역사 문서 (Phase 1 · TimePilot 시절)** — 본 문서와 `doc/0~5`는 초기 **Phase 1(Microsoft 단일 채널)** 설계 기준이라 현재 coffeeTide 정본과 다릅니다. 제품 정본은 **[doc/00-product-spec.md](../00-product-spec.md)**, 프로토타입 기술 레퍼런스는 **[doc/01-as-built-reference.md](../01-as-built-reference.md)**, 개선 백로그는 **[doc/02-backlog.md](../02-backlog.md)** 를 참조하세요.
