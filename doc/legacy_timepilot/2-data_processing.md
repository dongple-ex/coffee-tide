...
> ⚠️ **역사 문서 (Phase 1 · TimePilot 시절)** — 초기 Microsoft 단일 채널 설계 기록으로, 현재 coffeeTide 정본과 다릅니다. 특히 `UnifiedData.source` 유니온은 이후 `local_doc`·`gmail`·`llm`·`manual`·`paste` 등으로 확장 예정([`00-product-spec.md`](../00-product-spec.md) §3 참조).
